                            ...
                            designs.map((design: any) => (
                                <div key={design.id} className="group relative aspect-[4/5] bg-gray-900 rounded-[2rem] overflow-hidden group">
                                    <img
                                        src={design.imageUrl}
                                        alt={design.title}
                                        className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-[2000ms] brightness-110 saturate-105"
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-gray-950/40 via-transparent to-transparent flex flex-col justify-end p-8">
